...
**Additional gadgets inspired by the well-known AddGadgets.com Windows Sidebar gadgets and Orbmu2k's gadgets.**
...
* **Local Media Control**:
  ...
  - Not all features work with all players (more: [Rainmeter Documentation](https://docs.rainmeter.net/manual/measures/nowplaying/#playerlist))
* **Web Media Control**:
  - Shows metadata from a web media player and the cover-image if available, hover the skin to reveal the controls
  - A browser extension has to be installed! [Chrome](https://chromewebstore.google.com/detail/webnowplaying/jfakgfcdgpghbbefmdfjkbdlibjgnbli) [Firefox](https://addons.mozilla.org/en-US/firefox/addon/webnowplaying/)
  ...
  - Additionally the skin supports the Spotify Desktop App (including the cover what does not work with the Local Media Control), but sadly this doesn't work out of the box...
    - Patch your Spotify Desktop installation with [Spicetify](https://spicetify.app/docs/advanced-usage/extensions/#web-now-playing).
...
[![](https://github.com/Dudebaker/Gadgets-Additions/assets/2338122/c378a00f-c449-490f-9dfd-3bf8d4436e1c)](https://github.com/Dudebaker/Gadgets-Additions/assets/2338122/c378a00f-c449-490f-9dfd-3bf8d4436e1c)
[![](https://github.com/Dudebaker/Gadgets-Additions/assets/2338122/6778201f-5164-41df-be57-eab3f67ccc84)](https://github.com/Dudebaker/Gadgets-Additions/assets/2338122/6778201f-5164-41df-be57-eab3f67ccc84)
